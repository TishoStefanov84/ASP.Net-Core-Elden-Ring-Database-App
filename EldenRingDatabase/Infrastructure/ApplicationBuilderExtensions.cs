    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        private static void SeedWeaponTypes(EldenRingDbContext data)
        {
            ...
            data.WeaponTypes.AddRange(new[]
            {
                ...
                new WeaponType{Name = "StraightSwords"},
                new WeaponType{Name = "Greatswords"},
                new WeaponType{Name = "ColossalSwords"},
                new WeaponType{Name = "ThrustingSwords"},
                new WeaponType{Name = "HeavyThrustingSwords"},
                new WeaponType{Name = "CurvedSwords"},
                new WeaponType{Name = "CurvedGreatswords"},
                ...
                new WeaponType{Name = "GreatHammers"},
                new WeaponType{Name = "ColossalWeapons"},
                new WeaponType{Name = "Spears"},
                new WeaponType{Name = "GreatSpears"},
